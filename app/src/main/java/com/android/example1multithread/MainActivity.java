package com.android.example1multithread;
...
public class MainActivity extends Activity {
    ...
    final int MAX_SEC = 60; // dalam satuan secon untuk backroung thread
    ...
    Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage (Message msg) {
            ...
            //melakukan sesuatu dengan value yang di kirim di backround thread pada bagian ini...

            msgReturned.setText("returned by backround thread: \n\n" + returnedValue);
            bar1.incrementProgressBy(2);

            //melakukan pengetesan terhadap pembatasan threads
